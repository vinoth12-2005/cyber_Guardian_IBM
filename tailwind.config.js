...
export default {
  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        'glow-cyan':   '0 0 20px -4px rgba(6,182,212,0.30)',
        'glow-blue':   '0 0 20px -4px rgba(59,130,246,0.30)',
        'glow-purple': '0 0 20px -4px rgba(139,92,246,0.30)',
        'glow-sm':     '0 0 10px -2px rgba(6,182,212,0.20)',
        glow: "0 0 40px -10px rgba(59,130,246,0.45)",
        "glow-accent": "0 0 40px -10px rgba(6,182,212,0.45)",
        "glow-danger": "0 0 40px -10px rgba(239,68,68,0.45)",
        card: "0 8px 32px rgba(0,0,0,0.35)",
        'cyber-glow':  '0 0 20px -5px rgba(6, 182, 212, 0.25)',
        'blue-glow':   '0 0 20px -5px rgba(59, 130, 246, 0.25)',
        'purple-glow': '0 0 20px -5px rgba(139, 92, 246, 0.25)',
